    ...
    <div className="p-6 lg:p-8 bg-[#F4F5F7] min-h-screen">
      <div className="max-w-[1600px] mx-auto space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
          <StatCard label="Open Deals" value={stats?.openCount} icon={Target} accent="bg-[#3F51B5]/10 text-[#3F51B5]" />
          <StatCard
              ...
              {columns.map((column) => {
                ...
                return (
                  <div
                    ...
                    className={cn(
                      "w-72 shrink-0 bg-white rounded-xl shadow-sm border-t-4 transition-colors",
                      accent.border,
                  ...
                  >
                    ...
                    <div className="p-3 border-b border-gray-100 flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-bold text-sm text-gray-700">{STAGE_LABELS[column.stage]}</span>
                      ...
                      {column.opportunities.length === 0 ? (
                        ...
                        column.opportunities.map((opportunity) => (
                          <div
                            ...
                            className={cn(
                              "group bg-white border border-gray-100 rounded-lg p-3 shadow-sm hover:shadow-md hover:border-[#3F51B5]/30 transition-all cursor-grab active:cursor-grabbing",
                          ...
                          >
                            <div className="flex items-start justify-between gap-1">
                              <button
                                ...
                                className="font-semibold text-sm text-gray-800 text-left hover:text-[#3F51B5] transition-colors line-clamp-2"
                              >
                                {opportunity.name}
                              </button>
                            ...
                            {opportunity.customerName && (
                              <p className="text-xs text-gray-500 mt-1 flex items-center gap-1 truncate">
                                <Building size={11} className="shrink-0 text-gray-400" />
                                {opportunity.customerName}
                              </p>
                            )}
                            ...
                            <div className="flex items-center justify-between mt-2.5">
                              ...
                              <span className="text-[11px] font-semibold text-gray-400 flex items-center gap-0.5">
                                <Percent size={10} />
            ...
            <>
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4 pb-4 border-b border-gray-100">
                  <div className="min-w-0">
                    <h4 className="text-lg font-bold text-gray-900">{viewingOpportunity.name}</h4>
                    {viewingOpportunity.customerName && (
                      <span className="text-sm text-gray-500">{viewingOpportunity.customerName}</span>
                    )}
                  </div>
                ...
                {viewingOpportunity.lostReason && (
                  <div className="bg-red-50 border border-red-200 rounded-xl p-4 space-y-1">
                    <p className="text-xs text-red-400 uppercase tracking-wider font-semibold">Lost Reason</p>
                    <p className="text-sm text-red-800 whitespace-pre-wrap">{viewingOpportunity.lostReason}</p>
                  </div>
                )}
                ...
                <div className="space-y-2">
                  ...
                  {viewingOpportunity.stageHistory.length === 0 ? (
                    <p className="text-sm text-gray-400">No stage moves yet.</p>
                  ) : (
          ...
          {pendingLostMove && (
            <>
              <DialogHeader>
                ...
                <DialogDescription>
                  Why was <span className="font-semibold text-gray-700">{pendingLostMove.name}</span> lost?
            ...
            <>
              <DialogHeader>
                ...
                <DialogDescription>
                  ...
                  <span className="font-semibold text-gray-700">{deletingOpportunity.name}</span> (
